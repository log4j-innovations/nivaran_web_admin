  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 flex items-center justify-center">
          ...
          <p className="mt-2 text-sm text-gray-500">Please wait while we fetch system issues...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">System Issues Overview</h1>
          <p className="text-gray-600">Monitor all issues across the municipal system for better coordination</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-lg p-6 border border-purple-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-purple-700">My Tasks</p>
                <p className="text-3xl font-bold text-purple-900">
                  {issues.filter(i => i.assignedTo === user?.email).length}
                </p>
              </div>
            </div>
          </div>
